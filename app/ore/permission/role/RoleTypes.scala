...
object RoleTypes extends Enumeration {
  ...
  val CommunityLeader   =   new  RoleType( 3, 59,   Standard,   "Community Leader",      Amber)
  val Staff             =   new  RoleType( 4, 3,    Standard,   "Sponge Staff",          Amber)
  val SpongeDev         =   new  RoleType( 5, 41,   Standard,   "Sponge Developer",      Green)
  val WebDev            =   new  RoleType( 6, 45,   Standard,   "Web Developer",         Blue)
  val Scribe            =   new  RoleType( 7, 51,   Limited,    "Sponge Documenter",     Aqua)
  val Support           =   new  RoleType( 8, 43,   Limited,    "Sponge Support",        Aqua)
  val Contributor       =   new  RoleType( 9, 49,   Default,    "Sponge Contributor",    Green)
  val Adviser           =   new  RoleType(10, 48,   Default,    "Sponge Adviser",        Aqua)
  val DiamondDonor      =   new DonorType(11, 52,               "Diamond Donor",         LightBlue)
  val GoldDonor         =   new DonorType(12, 53,               "Gold Donor",            Gold)
  val IronDonor         =   new DonorType(13, 56,               "Iron Donor",            Silver)
  ...
  val ProjectSupport    =   new  RoleType(19, -4,   Default,    "Support",               Transparent)
