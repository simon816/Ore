...
object UserRoles extends Enumeration {
  ...
  val DiamondDonor      =      new Donor(10, 52,       "Diamond Donor",        LightBlue)
  val GoldDonor         =      new Donor(11, 53,       "Gold Donor",           Gold)
  val IronDonor         =      new Donor(12, 56,       "Iron Donor",           Silver)
  val QuartzDonor       =      new Donor(13, 54,       "Quartz Donor",         Quartz)
  val StoneDonor        =      new Donor(14, 57,       "Stone Donor",          Gray)
