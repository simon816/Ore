...
Running Ore is relatively simple. If you are using IntelliJ Ultimate Edition you should be able to import the
`build.sbt` file and just run it. Dependencies will be automatically resolved.
